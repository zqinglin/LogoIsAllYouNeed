...
In each pair below, **left is the original clip and right is the same clip with
the Sora logo stamped into the corner**. Nothing else about the video moves —
and VideoScore-v1.1's Visual Quality rises by **+1.3 to +1.6** on a 1–5 scale,
enough to carry every one of these clips from *rejected* to *near-passing*.

<p align="center">
  <img src="docs/gifs/pair_sora.gif" width="46%" alt="Sora clip: original on the left, logo-stamped copy on the right"/>
  &nbsp;&nbsp;&nbsp;&nbsp;
  <img src="docs/gifs/pair_hunyuan.gif" width="46%" alt="HunyuanVideo clip: original on the left, logo-stamped copy on the right"/>
</p>

<p align="center">
  <b>Sora</b> &nbsp;·&nbsp; VQ <b>1.75 → 3.19</b> &nbsp;·&nbsp; <code>+1.44</code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>HunyuanVideo</b> &nbsp;·&nbsp; VQ <b>1.52 → 3.08</b> &nbsp;·&nbsp; <code>+1.56</code>
</p>

<p align="center">
  <img src="docs/gifs/pair_ray2.gif" width="46%" alt="Ray2 clip: original on the left, logo-stamped copy on the right"/>
  &nbsp;&nbsp;&nbsp;&nbsp;
  <img src="docs/gifs/pair_pika.gif" width="46%" alt="Pika clip: original on the left, logo-stamped copy on the right"/>
</p>

<p align="center">
  <b>Ray2</b> &nbsp;·&nbsp; VQ <b>1.75 → 3.03</b> &nbsp;·&nbsp; <code>+1.28</code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Pika</b> &nbsp;·&nbsp; VQ <b>1.81 → 3.08</b> &nbsp;·&nbsp; <code>+1.27</code>
</p>

Full-quality mp4s, with scrub controls, are attached as [release assets](https://github.com/zqinglin/LogoIsAllYouNeed/releases/tag/v0.1-demo).

<details>
<summary><b>Per-dimension breakdown for these four clips</b></summary>

<br>

| Generator | Clip | VQ | TC | DD | TVA | FC |
|---|---|:-:|:-:|:-:|:-:|:-:|
| Sora | `0070_sora_0.mp4` | 1.75 → 3.19 (**+1.44**) | 1.30 → 2.11 (+0.80) | 3.09 → 3.36 (+0.27) | 2.89 → 3.02 (+0.12) | 1.55 → 2.59 (+1.04) |
| HunyuanVideo | `0062_hunyuan_1724.mp4` | 1.52 → 3.08 (**+1.56**) | 0.80 → 1.81 (+1.01) | 3.08 → 3.23 (+0.16) | 2.88 → 2.94 (+0.06) | 0.79 → 2.08 (+1.29) |
| Ray2 | `0034_ray2_1.mp4` | 1.75 → 3.03 (**+1.28**) | 1.92 → 2.31 (+0.39) | 2.88 → 2.88 (+0.00) | 2.48 → 2.73 (+0.25) | 2.05 → 2.55 (+0.50) |
| Pika | `0025_pika_2970469411.mp4` | 1.81 → 3.08 (**+1.27**) | 2.02 → 2.16 (+0.14) | 2.80 → 2.75 (−0.05) | 2.28 → 2.62 (+0.34) | 2.25 → 2.38 (+0.12) |

VQ = Visual Quality · TC = Temporal Consistency · DD = Dynamic Degree · TVA = Text–Video Alignment · FC = Factual Consistency
