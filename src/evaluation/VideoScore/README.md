...
## News
[2025-10-1] Release [VideoScore2](https://tiger-ai-lab.github.io/VideoScore2/)!
...
- for training
```bash
git clone https://example.com/anonymous
cd Mantis
...
## Acknowledgement
- Thanks [Mantis](https://example.com/anonymous) for the training codebase of VideoScore (and variants) and also for the plug-and-play MLLM tools in evaluation stage! 

- Thanks [VIEScore](https://example.com/anonymous) for some codes of prompting MLLM in evaluation! 
