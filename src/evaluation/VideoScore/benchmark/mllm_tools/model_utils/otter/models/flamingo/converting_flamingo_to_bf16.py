...
parser.add_argument("--pretrained_model_path", type=str, default="checkpoints/flamingo-mpt-7B-instruct-init", required=True)
parser.add_argument("--saved_model_path", type=str, default="checkpoints/flamingo-mpt-7B-instruct-init", required=True)
